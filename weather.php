...
$weather = json_decode(file_get_contents("http://api.openweathermap.org/data/2.5/weather?q=".$location."&appid=e452a367436f0555945ff6107612fb88"), TRUE)["weather"][0]["main"];
